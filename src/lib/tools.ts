...
export const tools: Tool[] = [
  {
    ...
    modes: [
      ...
      { slug: 'bmi', name: 'BMI Calculator', description: 'Calculate your Body Mass Index instantly. Metric and imperial units supported.', seoTitle: 'Free BMI Calculator — Body Mass Index in Metric & Imperial', seoDescription: 'Calculate your BMI instantly. Supports metric (kg/cm) and imperial (lbs/ft-in) units. Get your BMI category — underweight, normal, overweight, or obese. Free, no signup.', seoH1: 'BMI Calculator', keywords: ['bmi calculator', 'body mass index', 'bmi calculator kg', 'bmi calculator pounds', 'bmi chart'] },
      { slug: 'loan', name: 'Loan Calculator', description: 'Calculate loan monthly payments, total interest, and see an amortization schedule preview. Supports monthly and yearly terms.', seoTitle: 'Free Loan Calculator — Monthly Payments & Amortization Schedule', seoDescription: 'Calculate your loan monthly payments, total interest paid, and view an amortization schedule preview. Free, instant, no signup required. Works for personal loans, car loans, and student loans.', seoH1: 'Loan Calculator', keywords: ['loan calculator', 'personal loan calculator', 'car loan calculator', 'loan payment calculator', 'loan amortization calculator'] },
    ],
  },
  {
    slug: 'unit-converter',
